...
public class Movie implements Parcelable{
    ...
    public void writeToParcel(Parcel DestParcel, int flags) {
        ...
        DestParcel.writeByte((byte) (adult ? 1 : 0));
        ...
        DestParcel.writeString(originalLanguage);
        DestParcel.writeString(title);
        DestParcel.writeString(backdropPath);
        DestParcel.writeDouble(popularity);
        DestParcel.writeInt(voteCount);
        DestParcel.writeByte((byte) (video ? 1 : 0));
        DestParcel.writeDouble(voteAverage);
    }
}
