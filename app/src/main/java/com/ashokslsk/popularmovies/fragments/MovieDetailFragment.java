...
public class MovieDetailFragment  extends Fragment implements View.OnClickListener {
    ...
    {
        _subscriptions.add(//
                new MovieNetworkService(getActivity()).getMovieApi().fetchTrailers(movie.getId(), BuildConfig.MOVIE_DB_API_KEY)
    ...
    {
        _subscriptions.add(//
                new MovieNetworkService(getActivity()).getMovieApi().fetchReviews(movie.getId(), BuildConfig.MOVIE_DB_API_KEY)
                        .subscribeOn(Schedulers.io())
                        .observeOn(AndroidSchedulers.mainThread())
    ...
    public void setMovie(Movie movie) {
        this.movie = movie;
        backdrop.setImageResource(R.drawable.ic_placeholder);
        poster.setImageResource(R.drawable.ic_placeholder);
        initViews();
    }
